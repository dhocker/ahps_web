...
def create_db():
    ...
    # TODO Check for DB existence. If it does not exist, create a new
...
def convert_program(program, db):
...
def convert_device(device, db):
    ...
    for program in programs:
        convert_program(program, db)


def convert_room(room, db):
